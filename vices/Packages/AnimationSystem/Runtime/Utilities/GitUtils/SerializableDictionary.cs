...
public class SerializableDictionaryForAnimation
{
}

[Serializable]
public class SerializableDictionaryForAnimation<TKey, TValue> : SerializableDictionaryForAnimation, IDictionary<TKey, TValue>, ISerializationCallbackReceiver
{
    [SerializeField]
    ...
    public SerializableDictionaryForAnimation()
    {
        _keyPositions = new Lazy<Dictionary<TKey, uint>>(MakeKeyPositions);
    }

    public SerializableDictionaryForAnimation(IDictionary<TKey, TValue> dictionary)
    {
        _keyPositions = new Lazy<Dictionary<TKey, uint>>(MakeKeyPositions);
